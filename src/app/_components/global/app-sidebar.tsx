...
export default function AppSidebar({
  ...
  useEffect(() => {
    ...
    if (data && data.length > 0) {
      ...
      // Clear chatData if API returns empty array
      setChatData([]);
    }
  }, [data, setChatData]);
                  ...
                  >
                    ...
                    <DropdownMenu modal={false}>
                      <DropdownMenuTrigger asChild>
                        <SidebarMenuAction data-cy={`chat-actions-${chat.id}`}>
                          <MoreHorizontal />
                        </SidebarMenuAction>
                      </DropdownMenuTrigger>
      ...
      <SidebarFooter className="mb-4">
        <SidebarMenu>
          <SidebarMenuItem key="upgrade-plan" className="mx-auto">
            <SidebarMenuButton asChild>
              <Link href="/plans" data-cy="upgrade-plan-link">
                <CircleFadingArrowUp />
