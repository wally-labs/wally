...
import { HeroSection } from "./hero-section"; // Using named import

// Mock Child Components
const MockModelDropdown = () => (
  <div data-cy="mock-model-dropdown">ModelDropdown</div>
);
const MockSidebarTrigger = () => (
  <div data-cy="mock-sidebar-trigger">SidebarTrigger</div>
);
const MockClerkComponent = () => (
  <div data-cy="mock-clerk-component">ClerkComponent</div>
);
...
describe("<HeroSection />", () => {
  const TestChildren = () => (
    <div data-cy="test-children">Test Page Content</div>
  );
  ...
  it("renders children content below the header bar", () => {
    ...
    cy.get('[data-cy="hero-section-children-container"]')
      .find('[data-cy="test-children"]')
      .should("be.visible");
  });
});
